                ...
                <table className="w-full ">
                    ...
                    <tbody>
                        {clientes.filter(cl => cl.clave !== "PEG")
                            ...
                            .map(cliente => (
                                <tr key={cliente._id}
                                    className="odd:bg-gray-700 cursor-pointer hover:bg-gray-600 flex md:table-row md:flex-row flex-wrap md:flex-no-wrap py-5 md:mb-0"
                                    onClick={() => selectCliente(cliente)}>
                                    <td className="px-3 w-60 text-gray-300 whitespace-nowrap">
                                        <div className="md:hidden text-xs font-bold text-gray-500">Nombre</div>
                                        {cliente.nombre}
                                    </td>
                                    <td className="px-3 text-gray-300  ">
                                        <div className="md:hidden text-xs font-bold text-gray-500">Clave</div>
                                        {cliente.clave}
                                    </td>
                                    <td className="px-3 text-gray-300 whitespace-nowrap">
                                        <div className="md:hidden text-xs font-bold text-gray-500">Referencia</div>
                                        {cliente.ref}
                                    </td>
                                    <td className="px-3 text-gray-300 ">
                                        <div className="md:hidden text-xs font-bold text-gray-500">email</div>
                                        {cliente.email}
                                    </td>
                                    <td className="px-3 text-gray-300  ">
                                        <div className="md:hidden text-xs font-bold text-gray-500">Teléfono</div>
                                        {cliente.tel1}
                                    </td>
                                    <td className="px-3 text-gray-300  ">
                                        <div className="md:hidden text-xs font-bold text-gray-500">Ubicación</div>
                                        {cliente.ubicacion?.nombre}
                                    </td>
                                    <td className="px-3 text-gray-300 text-right ">
                                        <div className="md:hidden text-xs font-bold text-gray-500">Límite de crédito</div>
                                        {cliente.limite_de_credito}
                                    </td>
                                    <td className="px-3 text-gray-300 text-right ">
                                        <div className="md:hidden text-xs font-bold text-gray-500">Crédito disponible</div>
                                        {cliente.credito_disponible}
                                    </td>
                                    <td className="px-3 text-gray-300 text-right ">
                                        <div className="md:hidden text-xs font-bold text-gray-500">Saldo</div>
